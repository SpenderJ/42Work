...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2017/11/29 14:36:31 by juspende          #+#    #+#             */
/*   Updated: 2017/11/29 15:28:28 by juspende         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void		numj(int r, char *p, char *s);
void		ito10(uintmax_t, char *);
...
static char* g_ito10_tab100[100] =
{
...
static char* g_ito10_tab1000[1000] =
{
...
void				ito10(uintmax_t num, char *buf)
{
	int				r;
	char			*p;
	char			*s;
	...
	{
		s = g_ito10_tab100[num];
		*(uint16_t*)p = *(uint16_t*)s;
		p += 2;
	}
	else if (num < 1000)
	{
		s = g_ito10_tab1000[num];
		*(uint16_t*)p = *(uint16_t*)s;
		p += 2;
		*p++ = s[2];
	}
